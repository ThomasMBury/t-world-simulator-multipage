...
Run simulation of T-World model with
- initially periodic pacing
- then with a pause to check for DADs

On startup, display an empty figure.
...
from layout.protocol import make_protocol_section_dad
...
parameter_data["quiescence_duration"] = QUIESCENCE_DURATION_DEFAULT
...
register_run_button_dad(page_id, simulation)
